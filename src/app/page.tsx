      ...
      <section style={{
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{
            ...
            Dikerjakan langsung oleh owner berpengalaman. Dapatkan kenyamanan cukur premium, layanan cat rambut fashion, perm, hingga pembuatan dreadlocks berkualitas di Bandung.
          </p>
