          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1.25rem', flexWrap: 'wrap' }}>
            ...
            <a 
              href={`https://wa.me/6285382926336?text=${encodeURIComponent(
                ...
                `• ID Pemesanan: ${createdBooking?.id}\n` +
                `• Nama: ${createdBooking?.customerName}\n` +
                `• Layanan: ${selectedService?.title}\n` +
                `• Jadwal: ${createdBooking?.bookingDate} jam ${createdBooking?.bookingTime} WIB\n\n` +
                `Mohon bantuannya untuk dikonfirmasi. Terima kasih!`
              )}`}
              target="_blank"
